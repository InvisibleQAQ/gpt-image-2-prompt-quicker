...
window.UI.Pagination = class PaginationComponent {
    ...
    updateView() {
        ...
        const githubLink = this.element.querySelector('a[href="https://github.com/InvisibleQAQ/gpt-image-2-prompt-quicker"]');
    ...
    createSocialLinks() {
        ...
        const githubLink = h('a', {
            href: 'https://github.com/InvisibleQAQ/gpt-image-2-prompt-quicker',
            target: '_blank',
