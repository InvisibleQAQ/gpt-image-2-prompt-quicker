...
function loadSites({ querySelectorShadowDom } = {}) {
  ...
  vm.runInContext(fs.readFileSync('/root/25_banana-prompt-quicker/extension/sites/base.js', 'utf8'), context);
  vm.runInContext('this.BaseSite = BaseSite;', context);
  vm.runInContext(fs.readFileSync('/root/25_banana-prompt-quicker/extension/sites/chatgpt.js', 'utf8'), context);
